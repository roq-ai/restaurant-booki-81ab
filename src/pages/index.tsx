  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining your dining experience by making table reservations effortless. Empowering restaurant staff with efficient reservation and menu management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining your dining experience by making table reservations effortless. Empowering restaurant staff with efficient reservation and menu management.`}
            </Text>
            <Box
